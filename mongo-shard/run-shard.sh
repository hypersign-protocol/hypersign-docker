...
nohup mongod --configsvr  --port 28041 --replSet config_repl --dbpath ~/shard-demo/configsrv &
nohup mongod --configsvr  --port 28042 --replSet config_repl --dbpath ~/shard-demo/configsrv1 &
nohup mongod --configsvr  --port 28043 --replSet config_repl --dbpath ~/shard-demo/configsrv2 &
sleep 7
...
nohup mongod --shardsvr --port 28081 --replSet shard_repl --dbpath ~/shard-demo/shardrep1 &
nohup mongod --shardsvr --port 28082 --replSet shard_repl --dbpath ~/shard-demo/shardrep2 &
nohup mongod --shardsvr --port 28083 --replSet shard_repl --dbpath ~/shard-demo/shardrep3 &
sleep 7
...
nohup mongod --shardsvr --port 29081 --replSet shard2_repl --dbpath ~/shard-demo/shard2rep1 &
nohup mongod --shardsvr --port 29082 --replSet shard2_repl --dbpath ~/shard-demo/shard2rep2 &
nohup mongod --shardsvr --port 29083 --replSet shard2_repl --dbpath ~/shard-demo/shard2rep3 &
sleep 7
...
nohup mongos --configdb config_repl/localhost:28041,localhost:28042,localhost:28043 &
sleep 5
echo "Adding all shards.."
mongosh --host localhost --port 27017 --eval 'sh.addShard("shard_repl/localhost:28081,localhost:28082,localhost:28083"); sh.addShard( "shard2_repl/localhost:29081,localhost:29082,localhost:29083"); sh.status()'
